...
import { Button, InputNumber, Modal, Alert } from "antd";
    ...
    return (
      ...
      >
        ...
        <Modal footer={[<Button key="Approve" onClick={handleApprove}>
              Approve
            </Button>, <Button key="Stake" onClick={handleStake}>
              Stake
            </Button>, <Button key="Cancel" onClick={handleCancel}>
              Cancel
            </Button>]} title="Staking" open={isModalStakingOpen} onOk={handleOkStaking} onCancel={handleCancel}>
          <InputNumber style={{width: 400}} value={stakeAmount} onChange={handleStakeAmountChange}/>
        </Modal>.
          <Modal title="Reward" open={isModalRewardOpen}  footer={[<Button key="GetReward" onClick={handleReward}>
              Get Reward
